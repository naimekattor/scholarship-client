  ...
  return (
    <div className="bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {isLoading ? (
          <div className="flex justify-center py-16"><Loader2 className="h-12 w-12 animate-spin text-blue-600" /></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {scholarships.map((s) => (
                <Card key={s._id} className="hover:shadow-lg transition-shadow duration-300 flex flex-col">
                  ...
                  <CardFooter className="p-4 pt-0"><Button asChild className="w-full bg-blue-600 hover:bg-blue-700"><Link to={`/scholarship/${s._id}`}>View Details</Link></Button></CardFooter>
                </Card>
              ))}
            </div>
